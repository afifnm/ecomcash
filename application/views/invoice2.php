<div class="intro-y box overflow-hidden mt-5">
	<div class="border-b border-gray-200 text-center sm:text-left">
		<div class="px-5 py-10 sm:px-10 sm:py-10">
			...
			<a href="<?= base_url('assets/bukti/'.$pembelian->bukti); ?>" class="button inline-block bg-theme-1 text-white float-right ml-3 mr-3" target="_blank">
				Bukti Pembelian </a> 
			<div class="mt-2"> Nomor Pembelian <span class="font-medium">#<?= $nota ?></span> </div>
			<div class="mt-2"> Pesanan <span class="font-medium"><?= $pembelian->status ?></span> </div>
			<div class="mt-1">
				<?php
                $date=date_create($pembelian->tanggal);
