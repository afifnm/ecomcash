			...
			<tr>
				...
				<td class="border-b w-5">
					<div class="flex sm:justify-center items-center">
						...
						<a href="javascript:;" onclick="hapus(<?php echo $row['id_pelanggan'] ?>)"
							class="flex items-center text-theme-6" data-toggle="modal" data-target="#hapus-data">
							<i data-feather="trash-2" class="w-4 h-4 mr-1"></i>
							Delete </a>
						<?php } ?>
						<a href="<?= base_url('admin/pelanggan/transaksi/'.$row['id_pelanggan']) ?>"
							class="flex items-center text-theme-1">
							<i data-feather="shopping-cart" class="w-4 h-4 mr-1 ml-2"></i> Transaksi
						</a>
					</div>
				</td>
			</tr>
...
<div class="modal" id="header-footer-modal-preview">
	<div class="modal__content">
		...
		<form action="<?php echo site_url('admin/pelanggan/simpan');?>" method="POST">
			<div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
				...
				<div class="col-span-12 sm:col-span-12">
					<label>Alamat</label>
					<input type="text" name="alamat" class="input w-full border mt-2 flex-1" required>
				</div>
				<div class="col-span-12 sm:col-span-12">
					<label>No. Telp</label>
					<input type="text" name="telp" class="input w-full border mt-2 flex-1" required>
				</div>
			</div>
...
<div class="modal" id="edit-data">
	<div class="modal__content">
		<div class="flex items-center px-5 py-5 sm:py-3 border-b border-gray-200">
			<h2 class="font-medium text-base mr-auto">PERBARUI PELANGGAN </h2>
		</div>
		<form action="<?php echo site_url('admin/pelanggan/update');?>" method="POST">
			<input type="hidden" name="id_pelanggan" id="id" class="input w-full border mt-2">
			<div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
				<div class="col-span-12 sm:col-span-12">
					<label>Nama </label>
				...
				<div class="col-span-12 sm:col-span-12">
					<label>Alamat</label>
					<input type="text" name="alamat" class="input w-full border mt-2 flex-1" id="alamat">
				</div>
				<div class="col-span-12 sm:col-span-12">
					<label>No. Telp</label>
					<input type="text" name="telp" class="input w-full border mt-2 flex-1" id="telp">
				</div>
			</div>
			<div class="px-5 py-3 text-right border-t border-gray-200">
				<button type="submit" class="button w-20 bg-theme-1 text-white">Simpan</button>
...
<script>
	function edit(id, nama, alamat, telp) {
	...
	function hapus(id) {
		...
		link.href = "<?php echo site_url('admin/pelanggan/hapus/');?>" + id;
	};
</script>