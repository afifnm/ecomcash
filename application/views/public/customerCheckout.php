...
<body>
    ...
    <div class="container grid grid-cols-12 sm:grid-cols-1 items-start gap-6 pt-4 pb-16">
        ...
        <div class="col-span-8 border border-gray-200 p-4 rounded">
            <form action="<?= base_url('customer/bayar') ?>" method="post" id="form_pembayaran" enctype="multipart/form-data" onsubmit="return validateForm()">
                ...
                <div class="space-y-2">
                    <div>
                        <label for="pembayaran" class="text-gray-600 mb-2 block" id="metode_pembayaran">Metode Pembayaran</label>
                ...
                <div class="flex items-center mb-4 mt-2">
                    ...
                    <label for="agreement" class="text-gray-600 ml-3 cursor-pointer text-sm">
                        Saya setuju <a class="text-primary">dan yakin untuk membeli produk di atas.</a>
                    </label>
                </div>
