...
<body>
    ...
    <!-- ./categories -->
    <!-- new arrival -->
    <div id="semua_produk" class="container pb-16">
        ...
        <?php foreach($produk as $cc) { ?> 
            <div class="bg-white shadow rounded overflow-hidden group">
                ...
                <div class="pt-4 pb-3 px-4">
                    <h4 class="uppercase font-small fs-4 md:text-sm mb-2 text-gray-800 hover:text-primary transition"><?= $cc['nama']; ?></h4>
    ...
    <div class="container pb-16">
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
        <?php foreach($this->View_model->get_produk_terlaris(10) as $produkTerbaru) { ?> 
            <div class="bg-white shadow rounded overflow-hidden group">
                <div class="relative">
